  ...
  const drawer = (
    <>
      ...
      <List sx={{ paddingX: "30px" }}>
        <Typography variant="h6" marginBottom="20px">مێنیۆ</Typography>
        ...
        {user && (<>
          <Typography variant="h6" marginBottom="20px">تایبەت</Typography>
        ...
        <Typography variant="h6" marginBottom="20px">زێم</Typography>
        <ListItemButton onClick={onSwitchTheme}>
          ...
          <ListItemText disableTypography primary={
            <Typography textTransform="uppercase">
              {themeMode === themeModes.dark ? "باری تاریک" : " باری رووناک"}
            </Typography>
          } />
        </ListItemButton>
      </List>
